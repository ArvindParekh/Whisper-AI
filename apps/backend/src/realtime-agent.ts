...
Please help the user with their coding question in the context of this project.`;
    ...
    private async getProjectContext(): Promise<ProjectContext> {
        // This would need to be implemented to get context from the session
...
type SessionsStub = {
    syncFile: (filePath: string, fileContent: string, sessionId: string, type: syncFileType, timestamp: number) => Promise<syncFileResponseBody>;
