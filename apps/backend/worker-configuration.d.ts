/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4358a4335be619d60ecb78c97aba93ac)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		SESSIONS: DurableObjectNamespace<import("./src/agent-worker").WhisperSessionDurableObject>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_ID" | "API_TOKEN" | "ELEVENLABS_API_KEY" | "DEEPGRAM_API_KEY" | "REALTIME_KIT_AUTH_HEADER" | "REALTIME_KIT_API_KEY" | "REALTIME_KIT_ORG_ID">> {}
}
