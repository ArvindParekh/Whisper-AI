/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3840582c3114be6dec59dd9d9417a333)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "WhisperSessionDurableObject";
	}
	interface Env {
		WHISPER_TOKEN_STORE: KVNamespace;
		CODE_SUMMARIES: KVNamespace;
		ACCOUNT_ID: string;
		API_TOKEN: string;
		ELEVENLABS_API_KEY: string;
		DEEPGRAM_API_KEY: string;
		REALTIME_KIT_AUTH_HEADER: string;
		REALTIME_KIT_API_KEY: string;
		REALTIME_KIT_ORG_ID: string;
		GREPTILE_API_KEY: string;
		INDEXER_WORKER_URL: string;
		SESSIONS: DurableObjectNamespace<import("./src/workers/main").WhisperSessionDurableObject>;
		SYMBOLS_DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCOUNT_ID" | "API_TOKEN" | "ELEVENLABS_API_KEY" | "DEEPGRAM_API_KEY" | "REALTIME_KIT_AUTH_HEADER" | "REALTIME_KIT_API_KEY" | "REALTIME_KIT_ORG_ID" | "GREPTILE_API_KEY" | "INDEXER_WORKER_URL">> {}
}
